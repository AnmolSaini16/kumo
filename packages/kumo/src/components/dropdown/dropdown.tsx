          ...
          >
            <ScrollArea.Root className="group relative flex max-h-[inherit] flex-col">
              ...
              {/* Gradient scroll fades — composed outside viewport so they don't affect scroll height.
                  Rendered before Scrollbar so the scrollbar paints on top. */}
              ...
              <ScrollArea.Scrollbar className="pointer-events-none z-2 m-0.5 flex w-1 justify-center rounded-sm opacity-0 transition-opacity data-[hovering]:pointer-events-auto data-[hovering]:opacity-100 data-[scrolling]:pointer-events-auto data-[scrolling]:opacity-100 data-[scrolling]:duration-0">
